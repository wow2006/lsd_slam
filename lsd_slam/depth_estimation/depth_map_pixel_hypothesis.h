...
public:
  ...
  inline DepthMapPixelHypothesis(const float &my_idepth,
      ...
      : isValid(true), blacklisted(0), nextStereoFrameMinID(0),
        validity_counter(my_validity_counter), idepth(my_idepth),
        idepth_var(my_idepth_var), idepth_smoothed(my_idepth_smoothed),
  ...
  inline DepthMapPixelHypothesis(const float &my_idepth,
      ...
      : isValid(true), blacklisted(0), nextStereoFrameMinID(0),
        validity_counter(my_validity_counter), idepth(my_idepth),
        idepth_var(my_idepth_var), idepth_smoothed(-1),
