...
public:
   ...
   */
  inline void notify() { notifyCondition.notify_all(); }
...
public:
   ...
   */
  void setReceiver(Notifiable *receiver) { this->receiver = receiver; }
   ...
   */
  boost::recursive_mutex &getMutex() { return bufferMutex; }
