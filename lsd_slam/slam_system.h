...
public:
    ...
    * @param blockUntilMapped   Force to block this thread till mapping thread finish.
    ...
    */
    ...
    /** 
    * @brief finalizes the system, i.e. blocks and does all remaining loop-closures etc.
    */
    void finalize();
